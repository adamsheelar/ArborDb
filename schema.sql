...
CREATE DOMAIN RANK_ORDER AS VARCHAR(10)
...
CREATE TABLE EMPLOYED(
    ...
    WORKER VARCHAR(9),
        ...
        CONSTRAINT EMPLOYED_PK PRIMARY KEY (abbreviation,WORKER),
...
--Assumption1:
------------------------
-- FORESTs cannot exist in ArborDB without any TREE SPECIES being found in the FOREST
...
--Assumption 2:
------------------------
-- STATEs can exist in ArborDB without covering any FORESTs
...
--Assumption3:
------------------------
-- A STATE can exist in ArborDB without employing any WORKERs for maintaining FORESTs
